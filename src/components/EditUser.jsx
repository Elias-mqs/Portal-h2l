...
function EditUser({ user, onClose }) {
    ...
    const { control, handleSubmit, setValue, resetField } = useForm({
        ...
        defaultValues: { name: user.name, email: user.email, setor: user.setor, username: user.username, password: '' },
    });


    // por enquanto acho que nao vou precisar
    ...
    const handleForm = async (data) => {
        const newFormData = { ...data, info: user.info };
