...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////// FUNÇÃO PARA BUSCAR EQUIPAMENTOS QUANDO USUÁRIO ABRIR PÁGINA DE CHAMADOS ///////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
export default async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        ...
        const dataCript = req.url.split('/api/srcListChamOs/')[1];
        ...
        try {
            ...
            if (!info || !Array.isArray(info.ordens) || info.ordens.length === 0) {
                const message = !info ? 'Informações inválidas.' :
                    !Array.isArray(info.ordens) ? 'Informações inválidas.' :
